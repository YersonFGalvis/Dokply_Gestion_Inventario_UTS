...
__decorate([
    (0, typeorm_1.ManyToOne)(() => Equipo_1.Equipo, (equipo) => equipo.software),
    (0, typeorm_1.JoinColumn)({ name: 'equipo_id' }),
    __metadata("design:type", Equipo_1.Equipo)
], Software.prototype, "equipo_id", void 0);
__decorate([
    (0, typeorm_1.Column)({ length: 50 }),
    __metadata("design:type", String)
], Software.prototype, "licencia", void 0);
Software = __decorate([
    (0, typeorm_1.Entity)('softwareinstalado')
], Software);
