document.addEventListener("DOMContentLoaded", function () {
  ...
  <button 
    id="modal_edit"
    data-id="${id}"
    class="group text-[#132F20] border border-[#132F20] font-medium rounded-lg text-sm px-5 text-center me-2 mb-2 hover:text-white hover:bg-[#132F20] focus:ring-4 focus:outline-none focus:ring-blue-300 py-2.5 dark:border-blue-500 dark:text-blue-500 dark:hover:text-white dark:hover:bg-blue-500 dark:focus:ring-blue-800"
    data-action="edit"
    data-entity="${entity}">
    <svg class="w-6 h-6 text-[#132F20] group-hover:text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
  ...
  <button 
    id="modal_delete" 
    data-id="${id}"
    class="group text-[#6D100A] border border-red-700 font-medium rounded-lg text-sm px-5 text-center me-2 mb-2 hover:text-white hover:bg-[#6D100A] focus:ring-4 focus:outline-none focus:ring-red-300 py-2.5 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"
    data-action="delete"
    data-entity="${entity}">
    <svg class="w-6 h-6 text-[#6D100A] group-hover:text-white dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
